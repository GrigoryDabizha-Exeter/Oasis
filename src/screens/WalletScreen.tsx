...
const styles = StyleSheet.create({
    ...
    connectIcon: { fontSize: 48, color: '#00A0B2', marginBottom: 16 },
    connectTitle: { color: '#FFFFFF', fontSize: 22, fontWeight: '700', marginBottom: 8 },
    connectSub: { color: 'rgba(255,255,255,0.5)', fontSize: 14, textAlign: 'center', lineHeight: 20, paddingHorizontal: 16, marginBottom: 24 },
    connectBtn: { width: '100%' },
    balanceCard: { marginHorizontal: 16, marginBottom: 24 },
    balanceHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
    balanceLabel: { color: 'rgba(255,255,255,0.35)', fontSize: 11, fontWeight: '600', letterSpacing: 1 },
    address: { color: 'rgba(255,255,255,0.5)', fontSize: 13, fontFamily: 'monospace', marginBottom: 20 },
    ...
    balanceCurrency: { color: 'rgba(255,255,255,0.4)', fontSize: 12, fontWeight: '600', letterSpacing: 1, marginTop: 4 },
    balanceDivider: { width: 1, height: 48, backgroundColor: 'rgba(255,255,255,0.08)' },
    networkBadge: {
        flexDirection: 'row', alignItems: 'center', gap: 6,
        alignSelf: 'center', paddingHorizontal: 12, paddingVertical: 6,
        borderRadius: 20, backgroundColor: 'rgba(74, 222, 128, 0.1)',
    },
    networkDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#4ADE80' },
    networkText: { color: '#4ADE80', fontSize: 11, fontWeight: '600' },
    sectionTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '700', paddingHorizontal: 16, marginBottom: 4 },
    sectionSub: { color: 'rgba(255,255,255,0.4)', fontSize: 13, paddingHorizontal: 16, marginBottom: 16 },
    burnWrapper: { paddingHorizontal: 16, marginBottom: 10 },
    burnRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
    burnIcon: { fontSize: 28 },
    burnInfo: { flex: 1 },
    burnName: { color: '#FFFFFF', fontSize: 15, fontWeight: '600' },
    burnCost: { color: 'rgba(255,255,255,0.4)', fontSize: 12, marginTop: 2 },
    ...
    txTime: { color: 'rgba(255,255,255,0.35)', fontSize: 11, marginTop: 2 },
